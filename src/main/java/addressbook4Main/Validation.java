...
public class Validation {
    ...
    public boolean validateFirstName(String firstName) throws InvalidInputException {
         ...
         */
            ...
            throw new InvalidInputException("Invalid First Name, Please enter valid first name");
    }
    ...
    public boolean validateLastName(String lastName) throws InvalidInputException {
         ...
         */
            ...
            throw new InvalidInputException("Invalid Last Name, Please enter valid last name");
    }
    ...
    public boolean validateAddress(String address) throws InvalidInputException {
         ...
         */
            ...
            throw new InvalidInputException("Invalid Address, Please enter valid address");
    }
     ...
     * @throws ContactRegistrationException
     */
    public boolean validateCity(String city) throws InvalidInputException {
        /**
         ...
         */
            ...
            throw new InvalidInputException("Invalid City, Please enter valid city");
    }
     ...
     * @throws ContactRegistrationException
     */
    public boolean validateState(String state) throws InvalidInputException {
        /**
         * if regrex name patter match with last name then return true last name
         */
         ...
         */
            ...
            throw new InvalidInputException("Invalid State, Please enter valid state");
    }
     ...
     * @throws ContactRegistrationException
     */
    public boolean validateZip(String zip) throws InvalidInputException {
        /**
         ...
         */
            ...
            throw new InvalidInputException("Invalid Zip, Please enter valid zip");
    }
    ...
    public boolean validateEmail(String email) throws InvalidInputException {
        /**
         * if regex email patter match with email then return true email
         */
         ...
         */
            ...
            throw new InvalidInputException("Invalid Email, Please enter valid email");
    }
    ...
    public boolean validatePhoneNumber(String phoneNumber) throws InvalidInputException {
         ...
         */
            ...
            throw new InvalidInputException("Invalid Phone Number, Please enter valid phone number");
    }
}
